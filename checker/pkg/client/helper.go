...
func AttachRPCAdminClient(ctx context.Context, client *ssh.Client, pubKey ssh.PublicKey, noAuth bool) (*AdminClient, *CloseHandler, error) {
	...
	adminClient := NewAdminClient(grpcConn, pubKey)
